...
public class GraphView extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        aprLevelsPlot = (XYPlot) findViewById(R.id.plot);
    ...
    public void onPause() {
        redrawer.pause();
        super.onPause();
        //startService(new Intent(GraphView.this,BackgroundService.class));
